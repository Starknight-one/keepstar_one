...
func NewDebugHandler(statePort ports.StatePort, cachePort ports.CachePort, metricsStore *MetricsStore, eng *engine_v4.Engine) *DebugHandler {
	return &DebugHandler{
		statePort:    statePort,
		cachePort:    cachePort,
		metricsStore: metricsStore,
