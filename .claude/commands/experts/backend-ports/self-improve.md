# backend-ports Self-Improve

Update backend-ports expertise from codebase.

## Variables

USE_DIFF: $ARGUMENTS (true|false, default: false)
EXPERTISE: .claude/commands/experts/backend-ports/expertise.yaml
CONFIG: ADW/adw.yaml

## Instructions

- Scan codebase for backend-ports knowledge
...
```
backend-ports Expertise Updated
