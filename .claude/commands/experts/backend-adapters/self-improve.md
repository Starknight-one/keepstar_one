# backend-adapters Self-Improve

Update backend-adapters expertise from codebase.

## Variables

USE_DIFF: $ARGUMENTS (true|false, default: false)
EXPERTISE: .claude/commands/experts/backend-adapters/expertise.yaml
CONFIG: ADW/adw.yaml

## Instructions

- Scan codebase for backend-adapters knowledge
...
```
backend-adapters Expertise Updated
