# frontend-shared Self-Improve

Update frontend-shared expertise from codebase.

## Variables

USE_DIFF: $ARGUMENTS (true|false, default: false)
EXPERTISE: .claude/commands/experts/frontend-shared/expertise.yaml
CONFIG: ADW/adw.yaml

## Instructions

- Scan codebase for frontend-shared knowledge
...
```
frontend-shared Expertise Updated
