# frontend-entities Self-Improve

Update frontend-entities expertise from codebase.

## Variables

USE_DIFF: $ARGUMENTS (true|false, default: false)
EXPERTISE: .claude/commands/experts/frontend-entities/expertise.yaml
CONFIG: ADW/adw.yaml

## Instructions

- Scan codebase for frontend-entities knowledge
...
```
frontend-entities Expertise Updated
