# backend-usecases Self-Improve

Update backend-usecases expertise from codebase.

## Variables

USE_DIFF: $ARGUMENTS (true|false, default: false)
EXPERTISE: .claude/commands/experts/backend-usecases/expertise.yaml
CONFIG: ADW/adw.yaml

## Instructions

- Scan codebase for backend-usecases knowledge
...
```
backend-usecases Expertise Updated
