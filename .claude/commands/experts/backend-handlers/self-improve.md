# backend-handlers Self-Improve

Update backend-handlers expertise from codebase.

## Variables

USE_DIFF: $ARGUMENTS (true|false, default: false)
EXPERTISE: .claude/commands/experts/backend-handlers/expertise.yaml
CONFIG: ADW/adw.yaml

## Instructions

- Scan codebase for backend-handlers knowledge
...
```
backend-handlers Expertise Updated
