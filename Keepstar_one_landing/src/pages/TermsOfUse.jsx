...
const sections = [
  { title: '1. Acceptance of Terms', text: 'By accessing or using Keepstar One\'s services, website, or any associated applications (collectively, the "Service"), you agree to be bound by these Terms of Use. If you do not agree to all of these terms, do not use the Service. We reserve the right to update these terms at any time, and your continued use of the Service constitutes acceptance of any changes.' },
  { title: '2. Description of Service', text: 'Keepstar One provides an AI-powered dynamic website engine that replaces static pages with personalized experiences. The Service includes website generation, AI-driven content personalization, analytics, and related tools. We may modify, suspend, or discontinue any aspect of the Service at any time without prior notice.' },
  ...
  { title: '4. Intellectual Property', text: 'All content, features, and functionality of the Service — including but not limited to text, graphics, logos, icons, software, and AI-generated outputs — are owned by Keepstar One or its licensors and are protected by international copyright, trademark, and other intellectual property laws. You may not reproduce, distribute, or create derivative works without our express written permission.' },
  ...
  { title: '6. Limitation of Liability', text: 'To the maximum extent permitted by law, Keepstar One shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or business opportunities, arising out of or in connection with your use of the Service, whether based on warranty, contract, tort, or any other legal theory.' },
